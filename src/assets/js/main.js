// INDIGOLD — FW26 B2B Season Preview
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (gateForm) {
    ...
    gateForm.addEventListener('submit', (e) => {
      ...
      if (input.value === expected) {
        try { sessionStorage.setItem('indigold_gate_ok', '1'); } catch (err) {}
  ...
  document.querySelectorAll('[data-youtube]').forEach(el => {
    el.addEventListener('click', () => {
      ...
      el.innerHTML = `<iframe src="https://www.youtube-nocookie.com/embed/${id}?autoplay=1&rel=0" title="Indigold Brand Film" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen style="width:100%;height:100%;display:block;"></iframe>`;
    }, { once: true });
  });
